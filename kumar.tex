...
\date{\today}
\markboth{Journal of Science \& Engineering, Vol.~1, No.~2,~December 13, 2024}{Kumar \MakeLowercase{\textit{et al.}}: Mapping electric potential}
\setcounter{page}{17}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{akumar.jpeg}}]{Aadarsh Kumar} is a senior in the Science and Engineering Magnet Program at Manalapan High School and a member of the school swim team and band. His current senior project is to create a micromouse capable of mapping and navigating a maze at high speed. He is a fabulous tenor saxophonist. 
\end{IEEEbiography}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{sperkins.jpeg}}]{Steven Perkins} is a senior in the Science and Engineering Magnet Program at Manalapan High School and a member of the school swim team. He is also an intern in the Mechanical, Electrical, and Plumbing (MEP)  division at T\&M Engineering in Middletown, NJ.
\end{IEEEbiography}
...
\vfill
\newpage
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{hvillasenor.jpeg}}]{Henry Villase\~{n}or} is a senior in the Science and Engineering Magnet Program at Manalapan High School and a member of the school band. His current senior project is to create a micromouse capable of mapping and navigating a maze at high speed. He is known for baking linzer torte. 
\end{IEEEbiography}
